           ...
           {queue.length > 0 && currentIdx < queue.length && !result && (
             <div className="bg-slate-900/80 border border-slate-700/80 p-8 rounded-3xl shadow-2xl shadow-black/80 space-y-6">
               ...
               <form onSubmit={handleSubmit} className="space-y-4">
                 ...
                 <button type="submit" className="w-full py-5 bg-blue-600 hover:bg-blue-500 text-white font-black tracking-widest uppercase rounded-2xl transition-colors shadow-lg">Submit For Evaluation</button>
               </form>
             </div>
           )}
